...
stats = {'player':{
            ...
            'dealer': {'win':0,'lose':0,'tie':0,'blackjack':0}}
...
class Game():
    ...
    def hit_or_stand(self):
        #choice = inputput('Continue or stop? You have a ' + str(self.get_bust_probability(self.player.hand,self.dealer.hand)) + ' percent probability of busting') #use this later when I help the player if they need help
